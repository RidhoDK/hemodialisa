        ...
        <ul class="menu-inner py-1" style="background: #98FB98; color: white;">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item">
                <a href="../farmasi/stok_darah.php" class="menu-link">
            ...
            <div class="card mt-10">
              <div class="table-responsive">
                ...
                <table class="table">
                  ...
                  $no = 1;
                  $query = "SELECT * FROM tbl_resep WHERE 1=1"; // 1=1 untuk memudahkan penambahan kondisi
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td><?= $data['status'] ?></td>
                        <td>
                          <a href="../../html/edit-resep.php?id_resep=<?= $data['id_resep'] ?>" class="btn btn-outline-warning">Edit</a>

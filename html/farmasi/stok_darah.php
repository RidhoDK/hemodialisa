            ...
            <div class="card mt-10">
              <div class="table-responsive">
                ...
                <table class="table">
                  ...
                  $no = 1;
                  $query = "SELECT * FROM tbl_stokdarah WHERE 1=1"; // 1=1 untuk memudahkan penambahan kondisi
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a href="../../html/edit-stok.php?id_stokdarah=<?= $data['id_stokdarah'] ?>" class="btn btn-outline-warning">Edit</a>

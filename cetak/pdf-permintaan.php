...
$pdf->Cell(190, 10, 'Permohonan Permintaan Darah', 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->Cell(20, 10, 'Gol. Darah', 1, 0, 'C', true);
$pdf->Cell(15, 10, 'Rhesus', 1, 0, 'C', true);
$pdf->Cell(20, 10, 'Jumlah', 1, 0, 'C', true);
$pdf->Cell(25, 10, 'Tgl Permintaan', 1, 0, 'C', true);
$pdf->Cell(15, 10, 'Prioritas', 1, 0, 'C', true);
...
while ($data = mysqli_fetch_assoc($query)) {
    ...
    $pdf->Cell(20, 10, $data['gol_dar'], 1, 0, 'C');
    $pdf->Cell(15, 10, $data['rhesus'], 1, 0, 'C');
    $pdf->Cell(20, 10, $data['jumlah_diminta'], 1, 0, 'C');
    $pdf->Cell(25, 10, $data['tgl_permintaan'], 1, 0, 'C');
    $pdf->Cell(15, 10, $data['prioritas'], 1, 0, 'C');
